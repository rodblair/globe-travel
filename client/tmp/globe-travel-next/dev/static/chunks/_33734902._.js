...
"[project]/app/(app)/chat/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ChatPage() {
    ...
    const [activeTripId, setActiveTripId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "ChatPage.useState": ()=>{
            if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
            ;
    ...
    const [mapStops, setMapStops] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "ChatPage.useState": ()=>{
            if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
            ;
            try {
    ...
    const handlePlaceAdded = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPage.useCallback[handlePlaceAdded]": (event)=>{
            setMapStops({
                "ChatPage.useCallback[handlePlaceAdded]": (current)=>mergeStop(current, {
                        id: `${event.place.name}:${event.place.latitude}:${event.place.longitude}`,
                        title: event.place.name,
                        latitude: event.place.latitude,
                        longitude: event.place.longitude
                    })
            }["ChatPage.useCallback[handlePlaceAdded]"]);
        }
    }["ChatPage.useCallback[handlePlaceAdded]"], []);
    const handleNavigate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPage.useCallback[handleNavigate]": (event)=>{
            if (!event.latitude || !event.longitude) return;
            setMapStops({
                "ChatPage.useCallback[handleNavigate]": (current)=>mergeStop(current, {
                        id: `${event.name || 'place'}:${event.latitude}:${event.longitude}`,
                        title: event.name || 'Selected place',
                        latitude: event.latitude,
                        longitude: event.longitude
                    })
            }["ChatPage.useCallback[handleNavigate]"]);
        }
    }["ChatPage.useCallback[handleNavigate]"], []);
    const exploreChat = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useChat$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useChat"])({
        type: 'explore',
        onPlaceAdded: handlePlaceAdded,
        onNavigate: handleNavigate
    });
    const { data: tripPayload, isError: tripPreviewFailed } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            'chat-trip-preview',
            activeTripId
        ],
    ...
    const isPlanningPrompt = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPage.useCallback[isPlanningPrompt]": (text)=>{
    ...
    }["ChatPage.useCallback[isPlanningPrompt]"], []);
    const extractDraftDays = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPage.useCallback[extractDraftDays]": (text)=>{
            const match = text.match(/\b(\d+)\s+days?\b/i);
            if (!match) return 4;
            const parsed = Number(match[1]);
            return Number.isFinite(parsed) ? Math.min(14, Math.max(1, parsed)) : 4;
        }
    }["ChatPage.useCallback[extractDraftDays]"], []);
    const extractDraftTitle = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPage.useCallback[extractDraftTitle]": (text)=>{
    ...
    }["ChatPage.useCallback[extractDraftTitle]"], [
        extractDraftDays
    ]);
    const createDraftTrip = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPage.useCallback[createDraftTrip]": async (prompt)=>{
    ...
    }["ChatPage.useCallback[createDraftTrip]"], [
        extractDraftDays,
        extractDraftTitle
    ]);
    ...
    const handleBack = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPage.useCallback[handleBack]": ()=>{
            if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
            ;
            const sameOriginReferrer = typeof document.referrer === 'string' && document.referrer.startsWith(window.location.origin);
    ...
    const [planningError, setPlanningError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [planningInProgress, setPlanningInProgress] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const sendMessage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
    ...
    const tripDays = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ChatPage.useMemo[tripDays]": ()=>tripPayload?.days || []
    }["ChatPage.useMemo[tripDays]"], [
        tripPayload?.days
    ]);
    const resolvedSelectedDayIndex = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ChatPage.useMemo[resolvedSelectedDayIndex]": ()=>{
            if (!tripDays.length) return selectedDayIndex;
            return tripDays.some({
                "ChatPage.useMemo[resolvedSelectedDayIndex]": (day)=>day.day_index === selectedDayIndex
            }["ChatPage.useMemo[resolvedSelectedDayIndex]"]) ? selectedDayIndex : tripDays[0].day_index;
        }
    }["ChatPage.useMemo[resolvedSelectedDayIndex]"], [
        selectedDayIndex,
        tripDays
    ]);
    const mapSubtitle = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ChatPage.useMemo[mapSubtitle]": ()=>{
            if (tripDays.length) {
                const mappedDays = tripDays.filter({
                    "ChatPage.useMemo[mapSubtitle]": (day)=>(day.items || []).some({
                            "ChatPage.useMemo[mapSubtitle]": (item)=>item.place?.latitude != null && item.place?.longitude != null
                        }["ChatPage.useMemo[mapSubtitle]"])
                }["ChatPage.useMemo[mapSubtitle]"]).length;
    ...
    const previewDays = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ChatPage.useMemo[previewDays]": ()=>{
            return tripDays.map({
                "ChatPage.useMemo[previewDays]": (day)=>{
                    const stops = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$trips$2f$derivedStops$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildDisplayStops"])(day.items || []).filter({
                        "ChatPage.useMemo[previewDays].stops": (stop)=>stop.mapped
                    }["ChatPage.useMemo[previewDays].stops"]).map({
                        "ChatPage.useMemo[previewDays].stops": (stop)=>({
                                id: stop.id,
                                title: stop.title,
                                latitude: stop.latitude,
                                longitude: stop.longitude,
                    ...
                    }["ChatPage.useMemo[previewDays].stops"]);
                    return {
                        day,
                        stops,
                        routeGeojson: day.routes?.find({
                            "ChatPage.useMemo[previewDays]": (route)=>route.mode === 'walk'
                        }["ChatPage.useMemo[previewDays]"])?.geojson || day.routes?.[0]?.geojson || null,
    ...
    const destinationFallback = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ChatPage.useMemo[destinationFallback]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$trips$2f$derivedStops$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDestinationFallback"])(tripPayload?.trip.title)
    }["ChatPage.useMemo[destinationFallback]"], [
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: activeMessages.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        activeTripId && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: previewDays.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "space-y-3",
            ...
            activeMessages.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "relative z-10 flex-shrink-0 border-t border-white/10 bg-black/40 backdrop-blur-xl px-4 py-3",
                children: [
                    planningError && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(ChatPage, "Taad5QABOC94O2KgvekNVYpnsGo=", false, function() {
    return [
...
//# sourceMappingURL=_33734902._.js.map