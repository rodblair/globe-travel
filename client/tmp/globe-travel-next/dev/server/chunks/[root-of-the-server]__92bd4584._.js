...
"[project]/app/api/trips/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const CreateTripSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    ...
    destination_place_id: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().uuid().nullable().optional(),
...
async function GET() {
    ...
    const { data, error } = await supabase.from('trips').select('id,title,share_slug,is_public,start_date,end_date,updated_at,created_at').eq('user_id', user.id).order('updated_at', {
        ascending: false
    });
...
async function POST(req) {
    ...
    const share_slug = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$trips$2f$_utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["randomSlug"])();
    ...
    const daysCount = typeof payload.constraints?.days === 'number' ? Math.max(1, Math.min(30, Math.floor(payload.constraints.days))) : 4;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__92bd4584._.js.map