...
"[project]/app/api/trips/[id]/feedback/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_req, ctx) {
    ...
    const { data, error } = await supabase.from('trip_feedback').select('id,author_name,author_email,sentiment,comment,created_at').eq('trip_id', id).order('created_at', {
        ascending: false
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__939d49b3._.js.map