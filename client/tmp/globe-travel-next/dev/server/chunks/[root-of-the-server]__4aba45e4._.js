...
"[project]/app/api/trips/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const UpdateTripSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    ...
    start_date: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().nullable().optional(),
    end_date: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().nullable().optional(),
    travelers_count: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().int().min(1).max(20).optional(),
    pace: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$trips$2f$_utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TripPaceSchema"],
    budget_level: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$trips$2f$_utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TripBudgetSchema"],
    ...
    is_public: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].boolean().optional()
});
async function GET(_req, ctx) {
    ...
    const { data: days, error: daysErr } = await supabase.from('trip_days').select('id,day_index,date,title,notes').eq('trip_id', id).order('day_index', {
        ascending: true
    });
    ...
    if (!days || days.length === 0) {
        ...
        const { data: created, error: createErr } = await supabase.from('trip_days').insert({
            trip_id: id,
            day_index: 1
        }).select('id,day_index,date,title,notes').single();
        if (createErr) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    const { data: items, error: itemsErr } = dayIds.length === 0 ? {
        data: [],
        error: null
    } : await supabase.from('trip_items').select('id,trip_day_id,type,title,start_time,end_time,duration_minutes,cost_estimate,notes,metadata,order_index,place:places(id,name,country,latitude,longitude)').in('trip_day_id', dayIds).order('order_index', {
        ascending: true
    });
    ...
    const { data: routes, error: routesErr } = dayIds.length === 0 ? {
        data: [],
        error: null
    } : await supabase.from('trip_routes').select('trip_day_id,geojson,distance_m,duration_s,mode,updated_at').in('trip_day_id', dayIds);
    if (routesErr) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: routesErr.message
    }, {
        status: 500
    });
    const byDayItems = new Map();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4aba45e4._.js.map