  ...
  return (
    <div className="relative w-full h-full min-h-screen bg-[#050510] overflow-hidden">
      ...
      <div className="absolute top-4 right-4 z-10">
        ...
        >
          <div className="flex items-center gap-2 px-3 py-1.5 bg-black/50 backdrop-blur-xl border border-white/8 rounded-full">
            <Globe2 className="w-3 h-3 text-amber-400/80" />
            <span className="text-xs font-semibold text-white/90 tabular-nums">{countriesSet.size}</span>
            <span className="text-[10px] text-white/35">countries</span>
          </div>
          <div className="flex items-center gap-2 px-3 py-1.5 bg-black/50 backdrop-blur-xl border border-white/8 rounded-full">
            <MapPin className="w-3 h-3 text-emerald-400/80" />
            <span className="text-xs font-semibold text-white/90 tabular-nums">{visitedCount}</span>
            <span className="text-[10px] text-white/35">visited</span>
          </div>
          <div className="flex items-center gap-2 px-3 py-1.5 bg-black/50 backdrop-blur-xl border border-white/8 rounded-full">
            <Heart className="w-3 h-3 text-cyan-400/80" />
            <span className="text-xs font-semibold text-white/90 tabular-nums">{bucketCount}</span>
            <span className="text-[10px] text-white/35">bucket list</span>
          </div>
        </motion.div>
      </div>
