...
const DESTINATION_OVERRIDES: Record<string, GeocodeResult> = {
  ...
  'new york': {
    mapbox_place_id: 'manual:destination:new-york',
    name: 'New York',
  ...
  vancouver: {
    mapbox_place_id: 'manual:destination:vancouver',
    name: 'Vancouver',
    full_name: 'Vancouver, British Columbia, Canada',
    latitude: 49.28273,
    longitude: -123.12074,
    country: 'Canada',
    country_code: 'CA',
  ...
  'rio de janeiro': {
    mapbox_place_id: 'manual:destination:rio-de-janeiro',
    name: 'Rio de Janeiro',
  ...
  reykjavik: {
    mapbox_place_id: 'manual:destination:reykjavik',
    name: 'Reykjavik',
    full_name: 'Reykjavik, Iceland',
    latitude: 64.14658,
    longitude: -21.94264,
    country: 'Iceland',
    country_code: 'IS',
  ...
  crete: {
    mapbox_place_id: 'manual:destination:crete',
    name: 'Crete',
    full_name: 'Crete, Greece',
    latitude: 35.24012,
    longitude: 24.80927,
    country: 'Greece',
    country_code: 'GR',
  ...
  singapore: {
    mapbox_place_id: 'manual:destination:singapore',
    name: 'Singapore',
    full_name: 'Singapore',
    latitude: 1.35208,
    longitude: 103.81984,
  ...
  dubai: {
    mapbox_place_id: 'manual:destination:dubai',
    name: 'Dubai',
  ...
  kyoto: {
    mapbox_place_id: 'manual:destination:kyoto',
    name: 'Kyoto',
    full_name: 'Kyoto, Japan',
    latitude: 35.01156,
    longitude: 135.76815,
    country: 'Japan',
    country_code: 'JP',
  ...
  seattle: {
    mapbox_place_id: 'manual:destination:seattle',
    name: 'Seattle',
  ...
  bali: {
    mapbox_place_id: 'manual:destination:bali',
    name: 'Bali',
  ...
  nairobi: {
    mapbox_place_id: 'manual:destination:nairobi',
    name: 'Nairobi',
  ...
  'washington dc': {
    mapbox_place_id: 'manual:destination:washington-dc',
    name: 'Washington DC',
    full_name: 'Washington, District of Columbia, United States',
    latitude: 38.90719,
    longitude: -77.03687,
    country: 'United States',
    country_code: 'US',
  ...
  madrid: {
    mapbox_place_id: 'manual:destination:madrid',
    name: 'Madrid',
  ...
  seville: {
    mapbox_place_id: 'manual:destination:seville',
    name: 'Seville',
    full_name: 'Seville, Spain',
    latitude: 37.38909,
    longitude: -5.98446,
    country: 'Spain',
    country_code: 'ES',
