...
const PLANNER_PLACE_OVERRIDES: PlannerPlaceOverride[] = [
  ...
  { pattern: /^park(?:\s|,|$)|park rooftop|park bar/i, name: 'Park Rooftop', country: 'Portugal', country_code: 'PT', latitude: 38.71014, longitude: -9.14784, manualId: 'manual:lisbon:park-rooftop' },
