...
| pricing-alias | phone | `/account?tab=billing` | http://localhost:3000/account?tab=billing | Pass |
...
| pricing-alias | desktop | `/account?tab=billing` | http://localhost:3000/account?tab=billing | Pass |
