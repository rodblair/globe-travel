...
- Runtime deployment current: no, 1d7053e is waiting for production
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| P0 | production-runtime-deployment | production-runtime-deployment-currency | 2026-05-22 | production-on-0b0690d | Deploy runtime commit 1d7053e to production, then rerun launch gates. | `vercel deploy --prod --yes` | `n/a` |
