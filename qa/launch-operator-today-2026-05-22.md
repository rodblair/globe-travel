...
- Runtime deployment current: no, 6966b71 is waiting for production
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| P0 | production-runtime-deployment | production-runtime-deployment-currency | 2026-05-22 | production-on-e629404 | Deploy runtime commit 6966b71 to production, then rerun launch gates. | `vercel deploy --prod --yes` | `n/a` |
