...
- Passed: 3
- Failed: 0
- Artifact JSON: `qa/visual-baseline-2026-05-18-planner-start-recovery/summary.json`
- Artifact directory: `qa/visual-baseline-2026-05-18-planner-start-recovery`
...
| --- | --- | ---: | --- | ---: | ---: | ---: | --- | --- |
| planner | phone | 390 | No | 0 | 0 | n/a | qa/visual-baseline-2026-05-18-planner-start-recovery/screenshots/planner-phone-390x844.png | Pass |
| planner | laptop | 1280 | No | 0 | 0 | n/a | qa/visual-baseline-2026-05-18-planner-start-recovery/screenshots/planner-laptop-1280x800.png | Pass |
| planner | desktop | 1440 | No | 0 | 0 | n/a | qa/visual-baseline-2026-05-18-planner-start-recovery/screenshots/planner-desktop-1440x950.png | Pass |
