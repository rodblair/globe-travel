...
Generated at: 2026-06-05T23:10:17.713Z
...
- Production commit: 0d825fb5bbd29c113081b0a6cbaa526cf8590d54
- Production deployment: globe-travel-ghw9a3xqp-rodney-blairs-projects.vercel.app
...
- Beta review overdue waves: 5
- Beta review due-soon waves: 0
- Beta review dispatch prepared rows: 25
- Beta review dispatch due today: 0
- Beta review dispatch due soon: 0
- Beta review dispatch overdue: 25
- Beta review follow-ups due soon: 0
- Beta review follow-ups overdue: 25
...
- Latest production visual artifact: qa/visual-baseline-production-release-2026-06-05-0d825fb
- Latest production visual commit: 0d825fb5bbd29c113081b0a6cbaa526cf8590d54
- Latest production visual deployment: globe-travel-ghw9a3xqp-rodney-blairs-projects.vercel.app
...
- Production visual review dispatch log ready: yes (0 sent, 1 prepared not sent)
- Public launch blocker board ready: yes (25 beta rows, 1 required visual rows, 26 total rows)
- Launch operator today ready: yes (26 action rows, 25 beta, 1 visual, 26 send-packet rows, 6 execution steps, 25 beta unsent, 25 follow-ups blocked until initial sent proof, 1 required visual unsent)
- Launch operator overdue rehearsal ready: yes (5 overdue rows detected)
- Launch operator sent-dispatch rehearsal ready: yes (24 action rows after rehearsed sends)
...
- Dispatch sent-record template ready: yes (26 rows, ready for import: no, missing commands: 0, missing context: 0)
- Launch outreach brief ready: yes (26 rows, 26 CSV rows)
- Dispatch sent-record blank-template rejection ready: yes (26 rejected rows, canonical logs unchanged: yes)
- Review intake rehearsal ready: yes (1 beta invalid, 1 visual invalid)
- Review intake import rehearsal ready: yes (beta copied count 0->1, visual copied count 3->4)
...
- Public share map/itinerary catalog ready: yes (8/8 public shares, 16 viewports)
...
- JSON validation: `QA_BETA_REVIEW_DISPATCH_LOG=qa/beta-human-review-dispatch-log-all-wave-2026-05-21.json QA_VISUAL_REVIEW_DISPATCH_LOG=qa/production-visual-review-dispatch-log-2026-06-05.json QA_DISPATCH_MARK_SENT_RECORD=qa/dispatch-sent-record-template-2026-06-05.json npm run qa:dispatch-mark-sent`
...
- CSV validation: `QA_BETA_REVIEW_DISPATCH_LOG=qa/beta-human-review-dispatch-log-all-wave-2026-05-21.json QA_VISUAL_REVIEW_DISPATCH_LOG=qa/production-visual-review-dispatch-log-2026-06-05.json QA_DISPATCH_MARK_SENT_RECORD=qa/dispatch-sent-record-template-2026-06-05.csv npm run qa:dispatch-mark-sent`
...
- Send or escalate 25 overdue beta review dispatch message(s) from qa/beta-human-review-dispatch-outbox-all-wave-2026-05-21.json, then record sent evidence with qa/dispatch-sent-record-template-2026-06-05.csv, run QA_BETA_REVIEW_DISPATCH_LOG=qa/beta-human-review-dispatch-log-all-wave-2026-05-21.json QA_VISUAL_REVIEW_DISPATCH_LOG=qa/production-visual-review-dispatch-log-2026-06-05.json QA_DISPATCH_MARK_SENT_RECORD=qa/dispatch-sent-record-template-2026-06-05.csv npm run qa:dispatch-mark-sent to validate it, run QA_BETA_REVIEW_DISPATCH_LOG=qa/beta-human-review-dispatch-log-all-wave-2026-05-21.json QA_VISUAL_REVIEW_DISPATCH_LOG=qa/production-visual-review-dispatch-log-2026-06-05.json QA_DISPATCH_MARK_SENT_IMPORT=1 QA_DISPATCH_MARK_SENT_RECORD=qa/dispatch-sent-record-template-2026-06-05.csv npm run qa:dispatch-mark-sent to import the sent state, then rerun npm run qa:launch-refresh and npm run qa:launch-signoff.
- Send 1 production visual-review request(s) due soon from qa/production-visual-review-dispatch-outbox-2026-06-05.json, then record sent evidence with qa/dispatch-sent-record-template-2026-06-05.csv, run QA_BETA_REVIEW_DISPATCH_LOG=qa/beta-human-review-dispatch-log-all-wave-2026-05-21.json QA_VISUAL_REVIEW_DISPATCH_LOG=qa/production-visual-review-dispatch-log-2026-06-05.json QA_DISPATCH_MARK_SENT_RECORD=qa/dispatch-sent-record-template-2026-06-05.csv npm run qa:dispatch-mark-sent to validate it, run QA_BETA_REVIEW_DISPATCH_LOG=qa/beta-human-review-dispatch-log-all-wave-2026-05-21.json QA_VISUAL_REVIEW_DISPATCH_LOG=qa/production-visual-review-dispatch-log-2026-06-05.json QA_DISPATCH_MARK_SENT_IMPORT=1 QA_DISPATCH_MARK_SENT_RECORD=qa/dispatch-sent-record-template-2026-06-05.csv npm run qa:dispatch-mark-sent to import the sent state, then rerun npm run qa:launch-refresh and npm run qa:launch-signoff.
- Collect and import 25 completed beta review submission(s).
- Run, review, and import 1 scheduled production visual review date(s).
...
- Public launch blocker board: `qa/public-launch-blocker-board-2026-06-05.md`, `qa/public-launch-blocker-board-2026-06-05.csv`, and `qa/public-launch-blocker-board-2026-06-05.json`
- Launch operator today: `qa/launch-operator-today-2026-06-05.md`, `qa/launch-operator-today-2026-06-05.csv`, and `qa/launch-operator-today-2026-06-05.json`
- Launch operator sent-dispatch rehearsal: `qa/launch-operator-sent-dispatch-rehearsal-2026-06-05.md` and `qa/launch-operator-sent-dispatch-rehearsal-2026-06-05.json`
- Dispatch mark-sent dry run: `qa/dispatch-log-mark-sent-2026-06-05.md` and `qa/dispatch-log-mark-sent-2026-06-05.json`
- Dispatch mark-sent import rehearsal: `qa/dispatch-log-mark-sent-import-rehearsal-2026-06-05.md` and `qa/dispatch-log-mark-sent-import-rehearsal-2026-06-05.json`
- Dispatch sent-record template: `qa/dispatch-sent-record-template-2026-06-05.md`, `qa/dispatch-sent-record-template-2026-06-05.csv`, and `qa/dispatch-sent-record-template-2026-06-05.json`
- Launch outreach brief: `qa/launch-outreach-brief-2026-06-05.md`, `qa/launch-outreach-brief-2026-06-05.csv`, and `qa/launch-outreach-brief-2026-06-05.json`
- Dispatch sent-record blank-template rejection: `qa/dispatch-sent-record-template-rejection-2026-06-05.md` and `qa/dispatch-sent-record-template-rejection-2026-06-05.json`
- Review intake import rehearsal: `qa/review-intake-import-rehearsal-2026-06-05.md` and `qa/review-intake-import-rehearsal-2026-06-05.json`
...
- Latest production visual artifact: `qa/visual-baseline-production-release-2026-06-05-0d825fb` and `qa/visual-baseline-production-release-2026-06-05-0d825fb/summary.json`
...
- Visual dispatch outbox: `qa/production-visual-review-dispatch-outbox-2026-06-05.json`, `qa/production-visual-review-dispatch-outbox-2026-06-05.md`, `qa/production-visual-review-dispatch-outbox-2026-06-05.csv`, and `qa/production-visual-review-dispatch-outbox-2026-06-05`
- Visual dispatch log: `qa/production-visual-review-dispatch-log-2026-06-05.json`, `qa/production-visual-review-dispatch-log-2026-06-05.md`, and `qa/production-visual-review-dispatch-log-2026-06-05.csv`
...
- Accessibility: `qa/accessibility-keyboard-production-guest-2026-06-05-0d825fb/summary.json`
...
- Full route inventory: `qa/route-inventory-smoke-2026-06-04.json`
- Authenticated app surfaces: `qa/app-surfaces-smoke-2026-06-05.json`
- Production authenticated app surfaces: `qa/app-surfaces-production-guest-2026-06-05-0d825fb.json`
