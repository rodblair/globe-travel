...
- Passed: 3
- Failed: 0
- Artifact JSON: `qa/visual-baseline-billing-commercial-state/summary.json`
- Artifact directory: `qa/visual-baseline-billing-commercial-state`

| Route | Viewport | Width | Overflow | Small App Targets | Small Map Controls | Visual Diff | Screenshot | Result |
| --- | --- | ---: | --- | ---: | ---: | ---: | --- | --- |
| account-billing | tablet | 768 | No | 0 | 0 | n/a | qa/visual-baseline-billing-commercial-state/screenshots/account-billing-tablet-768x1024.png | Pass |
| account-billing | laptop | 1280 | No | 0 | 0 | n/a | qa/visual-baseline-billing-commercial-state/screenshots/account-billing-laptop-1280x800.png | Pass |
| account-billing | desktop | 1440 | No | 0 | 0 | n/a | qa/visual-baseline-billing-commercial-state/screenshots/account-billing-desktop-1440x950.png | Pass |
