...
- Summary JSON: `qa/release-candidate-layout-quality-2026-05-18/summary.json`
...
| local route smoke | Pass | 8 | 1.3s | no |
| auth and guest access smoke | Pass | 11 | 45.9s | local |
| local commercial smoke | Pass | 4 | 0.3s | no |
| local accessibility and keyboard smoke | Pass | 16 | 46.0s | no |
| public share and social preview smoke | Pass | 5 | 1.0s | no |
| public share recovery smoke | Pass | 3 | 12.6s | no |
| public share feedback mutation smoke | Pass | 5 | 1.3s | local |
| planner handoff smoke | Pass | 13 | 1.6s | local |
| billing recovery smoke | Pass | 9 | 15.9s | no |
| Stripe test-mode readiness | Pass | 11 | 0.6s | no |
| responsive visual QA | Pass | 45 | 126.7s | no |
