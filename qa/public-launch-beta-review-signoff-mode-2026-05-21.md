...
- `QA_LAUNCH_REQUIRE_PUBLIC_BETA_REVIEWS=1 QA_LAUNCH_EXPECTED_COMMIT=539506d829bdc4b7c66cb546e39b92a925e098e0 npm run qa:launch-signoff` fails as expected at `89/92`, with `0/25` completed beta reviews, `1/4` required production visual-review history entries, and a non-ready public-launch status.
