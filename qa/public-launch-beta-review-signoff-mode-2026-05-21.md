...
- `QA_LAUNCH_REQUIRE_PUBLIC_BETA_REVIEWS=1 QA_LAUNCH_EXPECTED_COMMIT=43ae6627da1211bd7f6c619b143575eccae0363b npm run qa:launch-signoff` fails as expected at `84/87`, with `0/25` completed beta reviews, `1/4` required production visual-review history entries, and a non-ready public-launch status.
