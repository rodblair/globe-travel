...
- Sent-record template: `qa/dispatch-sent-record-template-2026-06-06.json`
- Sent-record CSV to fill after real outreach: `qa/dispatch-sent-record-template-2026-06-06.csv`
- Outreach rows: 25 (25 beta, 0 visual)
...
This packet is a send bundle, not proof that anything was sent. Use it to copy the prepared messages into the external outreach channel. After real outreach happens, fill only the blank proof fields in `qa/dispatch-sent-record-template-2026-06-06.csv`, validate, import, then rerun launch gates.

## After Real Sends

- Validate filled CSV: `QA_BETA_REVIEW_DISPATCH_LOG=qa/beta-human-review-dispatch-log-all-wave-2026-05-21.json QA_VISUAL_REVIEW_DISPATCH_LOG=qa/production-visual-review-dispatch-log-2026-06-06.json QA_DISPATCH_MARK_SENT_RECORD=qa/dispatch-sent-record-template-2026-06-06.csv npm run qa:dispatch-mark-sent`
