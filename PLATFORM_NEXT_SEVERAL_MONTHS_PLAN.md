...
Deployment refresh: production is healthy on Vercel commit `c4c93cc838bd1c48a1ea6dcf2b76c4495cb21f46` at deployment `globe-travel-hzc30btur-rodney-blairs-projects.vercel.app`, and the latest counted production visual-review history evidence remains `qa/visual-baseline-production-runtime-current-2026-05-22-cc529ee` plus `qa/visual-baseline-production-runtime-current-2026-05-22-cc529ee/summary.json`, bound to commit `cc529ee622dc60720063c96131306562f90f4c31` and deployment `globe-travel-gfgkx2u63-rodney-blairs-projects.vercel.app`. The refreshed current-deployment production release gate `QA_BASE_URL=https://globe-travel-two.vercel.app QA_SHARE_SLUG=x3m2c8cnws npm run qa:release-production` passed `10/10`, production visual QA passed `25/25` in `qa/visual-baseline-production-release-2026-05-23`, production ops with required public metadata passed `3/3`, Athens public share/map integrity passed `5/5`, prompt-suite validation with the Athens production actual passed `60/60`, and production monitoring passed `9/9`. `npm run qa:launch-refresh` is the routine operator refresh command; it regenerates the daily launch board and public-launch status together, and the current evidence reports `beta-ready-public-blocked`, runtime deployment current `yes`, guardrail issues empty, beta reviews `0/25`, `25 remaining`, current wave `BETA-WAVE-01`, and production visual-review history `2/4` with `2 remaining`. The active evidence queues remain `qa/beta-human-review-next-wave-ops-2026-05-21.json`, `qa/beta-human-review-all-wave-ops-2026-05-21.json`, `qa/beta-human-review-follow-up-outbox-2026-05-21.json`, `qa/beta-human-review-wave-rehearsal-2026-05-22.json`, `qa/beta-human-review-matrix-rehearsal-2026-05-22.json`, `qa/public-launch-blocker-board-2026-05-21.json`, and the operator sent-record starter `qa/dispatch-sent-record-template-2026-05-22.json`, `qa/dispatch-sent-record-template-2026-05-22.md`, and `qa/dispatch-sent-record-template-2026-05-22.csv`. `npm run qa:launch-today` remains the guarded daily operator board with 5 due beta invites and 1 due visual-review assignment, while `npm run qa:dispatch-sent-record-template-rejection`, `npm run qa:review-intake-import-rehearsal`, and `npm run qa:public-launch-threshold-rehearsal` continue to prove sent-state, import, and threshold behavior without mutating canonical launch evidence. Production route inventory passes `22/22`, production app surfaces pass `22/22`, production guest accessibility/keyboard passes `22/22`, design-system readiness passes `11/11`, and `/pricing` remains a public acquisition surface with `Globe.travel pricing`, `Start 7-day free trial`, and `Adventurer`.
