...
Updated: 2026-06-05 current production checkpoint refreshed; beta/release-ops are ready while public launch remains blocked on external review evidence
...
Deployment refresh: production is healthy on Vercel runtime commit `4376c06cc6564f7932cbe179f295eee6e7d76805` at deployment `globe-travel-ewgh3tcs5-rodney-blairs-projects.vercel.app`. The current production visual evidence is `qa/visual-baseline-production-release-2026-06-05-4376c06` plus `qa/visual-baseline-production-release-2026-06-05-4376c06/summary.json`, bound to the same runtime commit and deployment; the production release gate passed `10/10`, production visual QA passed `25/25`, Athens public share/map integrity passed `5/5`, public share viral loop passed `5/5`, and prompt-suite validation with the Athens production actual passed `61/61`. The scheduled production visual-review history entry remains `qa/visual-baseline-production-release-2026-06-04` on deployment `globe-travel-g4uaa0zci-rodney-blairs-projects.vercel.app`; public launch still needs one additional distinct production visual-review date. `npm run qa:production-monitoring` passed `9/9` and writes `qa/production-monitoring-readiness-2026-06-05.md`.

`npm run qa:public-launch-status` reports status `beta-ready-public-blocked` with `guardrailIssues: []`; beta/release-ops are ready while public launch remains blocked by real external evidence. Beta reviews remain `0/25` with `25 remaining`, current wave `BETA-WAVE-01` is overdue but actionable in the command center, production visual-review history is `3/4` with `1 remaining`, and unsent review dispatches remain in the operator queue. The active evidence queues remain `qa/beta-human-review-next-wave-ops-2026-05-21.json`, `qa/beta-human-review-all-wave-ops-2026-05-21.json`, `qa/beta-human-review-follow-up-outbox-2026-05-21.json`, `qa/beta-human-review-wave-rehearsal-2026-05-22.json`, `qa/beta-human-review-matrix-rehearsal-2026-05-22.json`, `qa/public-launch-blocker-board-2026-06-05.json`, and the operator sent-record starter `qa/dispatch-sent-record-template-2026-06-05.json`, `qa/dispatch-sent-record-template-2026-06-05.md`, and `qa/dispatch-sent-record-template-2026-06-05.csv`. `npm run qa:launch-today` remains the guarded daily operator board with 25 overdue beta invite sends, one due-soon visual-review assignment, 26 send-packet rows, 6 execution steps, and exact sent-record handoff commands: `QA_BETA_REVIEW_DISPATCH_LOG=qa/beta-human-review-dispatch-log-all-wave-2026-05-21.json QA_VISUAL_REVIEW_DISPATCH_LOG=qa/production-visual-review-dispatch-log-2026-06-05.json QA_DISPATCH_MARK_SENT_RECORD=qa/dispatch-sent-record-template-2026-06-05.json npm run qa:dispatch-mark-sent`, `QA_BETA_REVIEW_DISPATCH_LOG=qa/beta-human-review-dispatch-log-all-wave-2026-05-21.json QA_VISUAL_REVIEW_DISPATCH_LOG=qa/production-visual-review-dispatch-log-2026-06-05.json QA_DISPATCH_MARK_SENT_IMPORT=1 QA_DISPATCH_MARK_SENT_RECORD=qa/dispatch-sent-record-template-2026-06-05.json npm run qa:dispatch-mark-sent`, `QA_BETA_REVIEW_DISPATCH_LOG=qa/beta-human-review-dispatch-log-all-wave-2026-05-21.json QA_VISUAL_REVIEW_DISPATCH_LOG=qa/production-visual-review-dispatch-log-2026-06-05.json QA_DISPATCH_MARK_SENT_RECORD=qa/dispatch-sent-record-template-2026-06-05.csv npm run qa:dispatch-mark-sent`, `QA_BETA_REVIEW_DISPATCH_LOG=qa/beta-human-review-dispatch-log-all-wave-2026-05-21.json QA_VISUAL_REVIEW_DISPATCH_LOG=qa/production-visual-review-dispatch-log-2026-06-05.json QA_DISPATCH_MARK_SENT_IMPORT=1 QA_DISPATCH_MARK_SENT_RECORD=qa/dispatch-sent-record-template-2026-06-05.csv npm run qa:dispatch-mark-sent`, then `npm run qa:launch-refresh` and `npm run qa:launch-signoff`. Current proof artifacts include `qa/launch-refresh-2026-06-05.json`, `qa/launch-refresh-2026-06-05.md`, `qa/dispatch-sent-record-template-rejection-2026-06-05.json`, `qa/dispatch-sent-record-template-rejection-2026-06-05.md`, `qa/review-intake-import-rehearsal-2026-06-05.json`, `qa/review-intake-import-rehearsal-2026-06-05.md`, `qa/public-launch-threshold-rehearsal-2026-06-05.json`, `qa/public-launch-threshold-rehearsal-2026-06-05.md`, `qa/public-launch-mode-rehearsal-2026-06-05.json`, `qa/public-launch-mode-rehearsal-2026-06-05.md`, `qa/vercel-ignore-smoke-2026-06-05.json`, and `qa/vercel-ignore-smoke-2026-06-05.md`. Local app surfaces pass `22/22` in `qa/app-surfaces-smoke-2026-05-27.json`, production route inventory passes `22/22` in `qa/route-inventory-smoke-2026-06-04.json`, production app surfaces pass `22/22` in `qa/app-surfaces-production-guest-2026-06-04.json` with generated guest cleanup, production guest accessibility/keyboard passes `22/22` in `qa/accessibility-keyboard-production-guest-2026-05-26/summary.json`, public metadata passes `6/6` in `qa/public-metadata-smoke-2026-05-26.json`, mobile readiness passes `9/9` in `qa/mobile-readiness-2026-05-26.json`, public share catalog integrity passes `7/7` live public shares and `14/14` phone/desktop renders after quarantining two non-launch-ready public QA links, with evidence in `qa/public-share-map-catalog-2026-05-26.json`, and `/pricing` serves the production title `Pricing · Globe.travel`.

The refreshed full local release-candidate matrix is `qa/release-candidate-full-with-multi-planner-2026-06-05/summary.json` and passed `35/35` with every launch option enabled. It refreshes regional planner actuals at `qa/release-candidate-full-with-multi-planner-2026-06-05/planner-generated-actuals-regional-edge-cities.json`, responsive visual QA `55/55`, accessibility/keyboard `22/22`, multi-itinerary browser UI `37/37`, hosted Stripe checkout `15/15`, hosted Stripe portal `16/16`, Trip Studio owner and feedback coverage, slow-network recovery, and fixture cleanup.

Production runtime commit is `4376c06`, which is deployed and verified on production. The next operations step is external review execution: send or reassign the 25 overdue beta invites, send the due-soon visual-review request for `PROD-VISUAL-HISTORY-004`, record sent proof with `qa/dispatch-sent-record-template-2026-06-05.csv`, validate/import that proof, then collect completed beta and visual review JSON evidence.

## Evidence History

The notes below are retained as a chronological implementation log. Treat them as historical evidence unless they explicitly point back to the Current Checkpoint above; they are not current production deployment pointers.

Earlier May 22 checkpoint: production evidence, beta-review execution, risk narrative, route inventory, authenticated app-surface coverage, deployment hygiene, and operator-facing docs were aligned after the public launch blocker-board gate reached production. `npm run qa:public-launch-status` reported live commit `2897c3a16d72c49852ace8763f0840972a647f31` on `globe-travel-dhghg8wn2-rodney-blairs-projects.vercel.app`, status `beta-ready-public-blocked`, beta/release-ops readiness green, guardrail issues empty, beta reviews `0/25` with `25 remaining`, and production visual-review history `2/4` with `2 remaining`. The invite-beta operating wave was `BETA-WAVE-01`, with reviewer outreach prepared in `qa/beta-human-review-next-wave-ops-2026-05-21.json`, `.md`, and `.csv`; these 5 next-wave operator rows were assignment evidence, not completed human-review evidence. The full invite-beta queue was also prepared in `qa/beta-human-review-all-wave-ops-2026-05-21.json`, `.md`, and `.csv`; `npm run qa:beta-review-all-wave-ops` verified 25/25 remaining reviewer outreach rows across all 5 scheduled waves and kept that artifact out of completed-review counts. `qa/public-launch-blocker-board-2026-05-21.json`, `.md`, and `.csv` combined those 25 beta rows with 3 scheduled production visual-review rows, marking the first 2 visual rows as required for public-launch history. The blocker board also exposed exact per-row next evidence actions, start URLs or production commands, packet/template paths, completed evidence paths, validation commands, and explicit import commands; `npm run qa:public-launch-blockers` verified all 28 row packet/template paths and commands before public launch status could remain green. `npm run qa:route-inventory` wrote `qa/route-inventory-smoke-2026-05-22.json` and verified 22/22 shipped top-level public, auth, protected, compatibility, and public-share routes against production, including source-file existence, public render markers, and protected login redirects; `npm run qa:app-surfaces` wrote `qa/app-surfaces-smoke-2026-05-22.json`, captured phone and desktop screenshots, and verified 22/22 local guest-auth checks for secondary authenticated routes and compatibility aliases including `/explore`, `/globe`, `/map`, `/bucket-list`, `/journal`, `/profile`, `/settings`, `/pricing`, `/onboarding`, `/trips`, and `/trips/new`; `npm run qa:app-surfaces-production` wrote `qa/app-surfaces-production-guest-2026-05-22.json`, captured the same 22/22 guest-auth checks against `https://globe-travel-two.vercel.app`, proved those authenticated shell destinations worked on the live alias too, and verified the generated guest profile plus auth user were deleted afterward. Public launch status and launch signoff were hardened to fail if the full route inventory, local app-surface evidence, production app-surface evidence, production guest cleanup proof, beta-review wave rehearsal evidence, beta-review full-matrix rehearsal evidence, beta-review production guest-start rehearsal evidence, beta all-wave ops evidence, or full blocker-board evidence was missing, stale, or broken; `npm run qa:beta-review-wave-rehearsal` wrote `qa/beta-human-review-wave-rehearsal-2026-05-22.json`, `.md`, and 5 screenshots, validating 5/5 next-wave reviewer start URLs, auth/guest prompt preservation, packet/template alignment, and no horizontal overflow, while `npm run qa:beta-review-matrix-rehearsal` wrote `qa/beta-human-review-matrix-rehearsal-2026-05-22.json`, `.md`, and 25 screenshots, validating 25/25 planned beta review packets from Athens through London without counting as completed human-review evidence. `npm run qa:vercel-ignore` wrote `qa/vercel-ignore-smoke-2026-05-22.json` and `.md`, passed `4/4`, proved three release-ops/evidence/workflow commit ranges skip Vercel builds, and proved one known runtime app change still continues a build. The production visual evidence for that checkpoint was `qa/visual-baseline-production-release-2026-05-22-2897c3a` and `qa/visual-baseline-production-release-2026-05-22-2897c3a/summary.json`, bound to commit `2897c3a16d72c49852ace8763f0840972a647f31` and deployment `globe-travel-dhghg8wn2-rodney-blairs-projects.vercel.app`. Launch signoff verified the 25-review beta execution schedule, beta next-wave ops pack, beta all-wave ops pack, beta wave rehearsal, beta full-matrix rehearsal, beta production guest-start rehearsal, public launch blocker board, full route inventory, local authenticated app surfaces, production authenticated app surfaces, accepted-risk evidence counts, current production visual evidence, current release-doc evidence markers, Vercel ignored-build smoke, monitoring, and rollback pointers. Exact signoff passed `106/106`; public launch blocker board passed `5/5` with `28` rows; beta matrix rehearsal passed `25/25`; beta production guest-start rehearsal passed with `1` exercised handoff and `0` cleanup failures; route inventory passed `22/22`; local authenticated app surfaces passed `22/22`; production authenticated app surfaces passed `22/22`; Vercel ignored-build smoke passed `4/4`; production release verification passed `10/10`; production visual QA passed `20/20`; public-share viral loop passed `5/5`; Athens five-day public-share map integrity passed `5/5`; prompt-suite production actual validation passed `60/60`; production monitoring passed `9/9`; and design-system readiness passed `10/10`. The full beta review matrix rehearsal gate commit was pushed to `main`, deployed by Vercel, and re-verified on the production alias with refreshed monitoring, rollback, risk, design-system, visual-review, and public-launch status evidence. The in-app Browser backend was unavailable in that run, so the verification path used the repo's Playwright-backed Browser QA runners and recorded evidence in `qa/visual-baseline-production-release-2026-05-22-2897c3a/`, `qa/app-surfaces-smoke-2026-05-22/`, `qa/app-surfaces-production-guest-2026-05-22/`, `qa/beta-human-review-matrix-rehearsal-2026-05-22/`, and `qa/vercel-ignore-smoke-2026-05-22.json`.

The newest public share map/itinerary integrity guard closes the current Athens five-day map trust issue as a repeatable release check. `npm run qa:share-map-integrity` now writes `qa/public-share-map-itinerary-integrity-2026-05-22.json`, `.md`, and phone/desktop screenshots in `qa/public-share-map-itinerary-integrity-2026-05-22/screenshots/`; it verifies the stable Athens share `x3m2c8cnws` has 5 itinerary days, mapped stops, one-country Greece routing, rendered day-by-day itinerary content, map surfaces, stop-count chips, share/copy controls, feedback surfaces, no unavailable state, no app error, and no horizontal overflow across 2 viewports. Public launch status and launch signoff now guard that artifact so missing, stale, broken, or screenshot-incomplete public share map/itinerary evidence blocks release readiness. The guarded run passed 1 share, 2 viewports, 5 days, and 0 failures; exact-commit launch signoff now passes `106/106`. The public launch blockers are unchanged: beta reviews remain `0/25`, and production visual-review history remains `2/4`.

The next public-share catalog hardening closes the larger production-data issue behind the single Athens check. `npm run qa:share-map-catalog` now discovers live public shares from Supabase and validates every discovered public itinerary/map link against production. The first catalog run found 5 public shares: Athens `x3m2c8cnws` passed, one stale QA fixture was still public, and 3 older itinerary links had duplicate mapped-stop or missing-route issues. `npm run qa:share-catalog-quarantine` then set the 4 non-launch-ready links private without deleting their trips. The May 26 refresh found 9 live public shares, caught two new non-launch-ready links (`87ye88fo9k` with an empty public itinerary and `670sgblw65` with internal QA feedback exposed), applied the quarantine workflow to set both private, and the latest rerun now discovers 7 public shares with 7/7 API/map integrity passes and 14/14 phone/desktop render passes. Public launch status and launch signoff now default to the latest `qa/public-share-map-catalog-YYYY-MM-DD.json` artifact and require live catalog discovery, so a hidden broken public itinerary cannot pass release readiness just because the stable Athens URL works.

The current evidence-binding fix closes one launch-packet drift hole: design-system readiness, public launch status, and launch signoff now require the design-system production visual artifact to exactly match the latest production visual-review register summary. The stale `qa/visual-baseline-production-release-2026-05-22/summary.json` pointer was caught, refreshed to `qa/visual-baseline-production-release-2026-05-22-2897c3a/summary.json`, and exact-commit launch signoff still passes `104/104`.

The beta-operations hardening keeps the human-review wave plan from quietly going stale. `npm run qa:beta-review-command-center` exposes due-soon and overdue waves with review ids, due dates, and remaining counts so operators can escalate without mistaking overdue outreach for completed-review evidence. Public launch status exposes due-soon and overdue wave counts, and the all-wave ops artifact computes `daysUntilDue` per review row across all 25 reviewers. The current checkpoint above is authoritative for today's exact overdue and due-today counts.

The current visual-review operations hardening applies the same rule to dated production visual QA. `npm run qa:visual-review-progress` now records per-review due status, fails if a scheduled production visual-review date is overdue, and public launch status exposes due-soon and overdue visual-review counts. The active production visual queue has `1` due-soon review, `0` overdue reviews, and the next required visual review due on `2026-05-28`.

The newest beta-review Browser-handoff hardening closes a rehearsal blind spot. The default wave and matrix rehearsals remain non-mutating, but `QA_BETA_REVIEW_WAVE_REHEARSAL_ALLOW_REMOTE_GUEST_START=1` now performs a limited real production guest-start click, verifies the prompt-preserving handoff into the generated Trip Studio route, records cleanup proof, and fails if the disposable trip, profile, or auth user cannot be deleted. The focused Athens mobile proof passed `5/5` in `qa/beta-human-review-guest-start-rehearsal-2026-05-22.json`, and public-launch status plus launch signoff now guard that artifact so missing, stale, broken, or uncleaned production guest-start evidence blocks release readiness.

The remaining public-launch evidence queues are still executable end to end without loosening the real thresholds. `npm run qa:beta-review-packets` writes `25/25` reviewer packets, `25/25` matching JSON submission templates, and `qa/beta-human-review-assignments-2026-05-21.csv/.md`; `npm run qa:beta-review-all-wave-ops` writes the 25-row all-wave outreach board for the full planned review queue; `npm run qa:visual-review-schedule` writes scheduled production visual-review templates plus `qa/production-visual-review-assignments-2026-05-21.csv/.md`; `npm run qa:visual-review-progress` proves the latest visual artifact and dated history state; and `npm run qa:launch-refresh` keeps the daily board and public-launch status aligned. The current checkpoint above supersedes the older May 23 refresh artifacts and is the source of truth until a new evidence cycle is intentionally generated.

The newest release-ops guardrail prevents premature evidence counting. Beta human-review intake, beta-review progress/readiness, production visual-review intake/progress, and launch signoff now reject future-dated completed evidence, and a negative intake check confirmed fake `2099-05-28` beta and visual submissions fail before import. This keeps the scheduled visual-review queue useful without allowing future due dates to satisfy today's public-launch thresholds.
...
2. Athens five-day release anchor:
   ...
   - Historical May 21 recovery check: commit `f07fbad` was live on Vercel production for that recovery release; missing Trip Studio routes rendered recovery instead of lingering on the loading skeleton, the Athens public-share viral loop passed `5/5`, and full production `qa:release-production` passed `10/10` with production visual QA `20/20`.
...
Historical May 21 signoff checkpoint: `npm run qa:launch-signoff` became the fast evidence audit for release meetings. It passed `32/32` on 2026-05-21, proving production health `11/11`, full local release-candidate evidence `35/35`, responsive visual QA `50/50`, all `50` visual screenshots present, hosted Stripe evidence, launch docs, fresh postdeploy production evidence, current launch risk register, current rollback plan, and fresh regional generated-itinerary map-trust evidence for Istanbul, Seoul, Bangkok, Marrakech, Cape Town, and Sydney. Use the Current Checkpoint section above for today's production commit and `QA_LAUNCH_EXPECTED_COMMIT=<sha>` when a launch meeting needs the audit to prove a specific production commit is live.

Historical May 21 production checkpoint: commit `f07fbad` (`f07fbadc7fdad3c54d23123d2e0e9473609c5dc3`) was the live production deployment for that recovery fix. Production `qa:release-production` passed `10/10`, production visual QA passed `20/20` in `qa/visual-baseline-production-recovery-2026-05-21-f07fbad/`, and the fast launch audit was run with `QA_LAUNCH_EXPECTED_COMMIT=f07fbadc7fdad3c54d23123d2e0e9473609c5dc3`.
